...
const names = ['Mohammad', 'Sofia', 'Ahmed', 'Elena', 'Ivan', 'Rajesh', 'Anna', 'Victor', 'Maria', 'John', 'Александр', 'Ольга', 'Дмитрий', 'Наталья', 'Сергей', 'Татьяна', 'Андрей', 'Екатерина', 'QwErTy', 'AbCdEf', 'XyZkLm', 'PqRsTu', 'MnBvCx', 'HjKlPo', 'WsXcDe', 'NmKjHg', '1win', 'Player123', 'GameMaster', 'Lucky777', 'Winner21', 'ProGamer', 'Master99', 'Olivia', 'Liam', 'Sophia', 'Jackson', 'Amelia', 'Mason', 'Isabella', 'Ethan', 'Avery', 'Sebastian', 'Harper', 'Henry', 'Ella', 'Alexander', 'Mia', 'Jacob', 'Charlotte', 'Michael', 'Zachary', 'Charlotte', 'Grace', 'Benjamin', 'Samuel', 'Lily', 'Ella', 'David', 'William', 'Alice', 'Emma', 'James', 'Luca', 'Emma', 'Max', 'Scarlett', 'Jasper', 'Nora', 'Eliza', 'Hazel', 'Leo', 'Chloe', 'Luca', 'Mila', 'Elijah', 'Anna', 'Emma', 'Emily', 'Archer', 'Владимир', 'Иван', 'Мария', 'Светлана', 'Юлия', 'Анастасия', 'Максим', 'Ксения', 'Тимофей', 'Семен', 'Григорий', 'Никита', 'Евгения', 'Кирилл', 'Михаил', 'Даниил', 'Дарина', 'Алиса', 'Ярослав', 'Николай', 'Федор', 'Полина', 'София', 'Артур', 'Марат', 'Роман', 'Анатолий', 'Екатерина', 'Милана', 'Илья', 'Даниил', 'Маргарита', 'Тимур', 'Вероника', 'Людмила', 'Станислав', 'Зоя', 'Лариса', 'Денис', 'Алексей', 'Ксения', 'Анна', 'Валентина', 'Дина', 'Раиса', 'Ирина', 'Андрей', 'Дарина', 'Юрий', 'Лев', 'Геннадий', 'Евгений', 'Милена', 'Александра', 'Людмила', 'Ирина', 'Евгений', 'Татьяна', 'Мария', 'Вячеслав', 'Валерий', 'Grace', 'John', 'Jack', 'William', 'Emily', 'Charlotte', 'Lily', 'Amelia', 'Sophia', 'Mason', 'Oliver', 'Leo', 'Isaac', 'James', 'George', 'Benjamin', 'Alexander', 'Harper', 'Charlotte', 'Victoria', 'Mila', 'Eli', 'Hudson', 'Zoe', 'Ella', 'Lucas', 'Ava', 'Noah', 'Charlotte', 'Hannah', 'Maddox', 'Mila', 'Scarlett', 'Oliver', 'Henry', 'Luca', 'Maxwell', 'Nathan', 'Freya', 'Elijah', 'Ezra', 'Chloe', 'Ruby', 'Isabelle', 'Sophia', 'Oliver', 'Max', 'Aiden', 'Levi', 'Evelyn', 'Landon', 'Nora', 'Harvey', 'Ellie', 'Mason', 'Violet', 'Cora', 'Matilda', 'Liam', 'Emerson', 'Jaxon', 'Riley', 'Grayson', 'Sophie', 'Mia', 'Jackson', 'Amos', 'Winston', 'Grace', 'Maggie', 'Daisy', 'Beau', 'Harold', 'Tessa', 'Hazel', 'Felicity'];

const currencies = ['$', '₹', 'GH₵', '₣', 'N', 'S', '€', '¥', '$', '₣', '£', '₡', '₲', '₤', '₼', '₴', '₳', '₵', '₲', '₹', '₱', '៛', '៛', '₡', '₯', '₠', '₣', '₥', '$', '₹', '₴', '₿', '₶', '৳', '฿', '₯', '₳', '₨', '₲', '₹', '₶', '₩', '₿', '₸', '₤', '₯', '₳', '₱', '₺'];
...
let bet_amount_value = 1;
let possiblleMaxWin = 1 * 0.99;
let prepossiblleMaxWin = 1 * 0.99;
let preMassiv = 0;
...
export async function playGame() {
  if (bet_amount_value >= 0.1 && bet_amount_value <= 200) {
                ...
                document.querySelector(".status-bar").innerHTML = `
                    ...
                    <div class="status-bar__status">
                      ...
                      <div class="status-bar__status-content"><span class="status-bar__status-title">Следующий шаг</span>
                        <div class="status-bar__status-text"><span class="status-bar__status-text-amount possiblleMaxWin" id="possibleMaxWinAmount">${possiblleMaxWin.toFixed(2).toLocaleString('ru-RU', {
                    useGrouping: true
                })}</span><span class="text-sm leading-4">&nbsp;</span><span class="status-bar__status-text-currency">$</span></div>
                      </div>
                    </div>
...
`;
  ...
  `;
            ...
            document.querySelector(".alert-popup").style.animation = "popup 1s forwards";
            document.querySelector(".alert-popup").style.display = "flex";

            setTimeout( () => {
                document.querySelector(".alert-popup").style.animation = "popupOut 1s forwards";
...
export function overlayAnimation() {
    ...
    document.querySelector('.winJackpotAmountclass').innerHTML = `${prepossiblleMaxWin.toLocaleString('ru-RU', {
        useGrouping: false
    }).replace(/,/g, '.')} $`;
...
`;
    setTimeout( () => {
        document.querySelector(".cells-board").outerHTML = `<div class="cells-board">
                      <button
                        ...
                        style="z-index: 0; display: none;"><div
                          ...
                          style="translate: none; rotate: none; scale: none; transform: translate(550px, 150px) rotate(-59.200deg) skew(0.000286479deg, 0deg);"></div></div></div>`;
      ...
      <div class="status-bar">
          <div class="status-bar__status">
            ...
            <div class="status-bar__status-content"><span class="status-bar__status-title">Макс. выигрыш</span>
              <div class="status-bar__status-text"><span class="status-bar__status-text-amount" id="possibleMaxWinAmount">${act2.toLocaleString('ru-RU', {
            useGrouping: true
        }).replace(/,/g, '.')}</span><span class="text-sm leading-4">&nbsp;</span><span class="status-bar__status-text-currency">$</span></div>
            </div>
          </div>
              ...
              <div class="basis-2/3">
                <div class="input-state-panel base-input">
                  <div class="flex w-full">
                    ...
                    <!-- value -->
                    <div class="app-input flex flex-1 justify-center"><input oninput='onInput("amount_field")' id="amount_field" maxlength="8" autocomplete="off" value="${bet_amount_value}" type='number' max='200' min='5' style="width: 70px;"><div class="ml-1 my-auto"><div id="currentBetCurrency" class="app-input__currency">$</div></div></div>
    ...
    cellButton.forEach( (button) => {
        button.onclick = async () => {
          ...
          `;
                ...
                const notPressedButtons = Array.from(cellButton).reduce( (acc, button, idx) => {
...
export function prevPreset() {
    ...
    document.getElementById('possibleMaxWinAmount').innerText = actualValue.toLocaleString('ru-RU', {
        useGrouping: true
    }).replace(/,/g, '.');
    trapsAmount = element;
}
